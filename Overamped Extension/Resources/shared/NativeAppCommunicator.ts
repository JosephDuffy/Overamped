...
type RequestRedirectOnlySettingBrowserMessage = {
  request: "settings";
  payload: {
    settings: ["redirectOnly"];
  };
};

type RequestIgnoredHostnameSettingBrowserMessage = {
  request: "settings";
  payload: {
    settings: ["ignoredHostnames"];
  };
...
type RequestRedirectOnlyAndIgnoredHostnameSettingBrowserMessage = {
  request: "settings";
  payload: {
    settings: ["redirectOnly", "ignoredHostnames"];
  };
...
type IgnoreHostnameBrowserMessage = {
  request: "ignoreHostname" | "removeIgnoredHostname";
  payload: {
    hostname: string;
  };
};

type MigrateIgnoredHostnameBrowserMessage = {
  request: "migrateIgnoredHostnames";
  payload: {
    ignoredHostnames: string[];
  };
...
type LogReplaceLinksBrowserMessage = {
  request: "logReplacedLinks";
  payload: {
...
type LogRedirectedLinkBrowserMessage = {
  request: "logRedirectedLink";
  payload: {
    contentType: "AMP" | "Yandex Turbo" | "Install Checker";
    fromURL: URL;
...
type BrowserMessage =
  | RequestRedirectOnlySettingBrowserMessage
  | RequestIgnoredHostnameSettingBrowserMessage
  | RequestRedirectOnlyAndIgnoredHostnameSettingBrowserMessage
  | IgnoreHostnameBrowserMessage
  | MigrateIgnoredHostnameBrowserMessage
  | LogReplaceLinksBrowserMessage
  | LogRedirectedLinkBrowserMessage;

type BrowserMessageResponse<Message> =
  Message extends RequestRedirectOnlySettingBrowserMessage
    ? RedirectOnlySettingsPayload
    : Message extends RequestIgnoredHostnameSettingBrowserMessage
    ? IgnoredHostnamesSettingsPayload
    : Message extends RequestRedirectOnlyAndIgnoredHostnameSettingBrowserMessage
    ? RedirectOnlySettingsPayload & IgnoredHostnamesSettingsPayload
    : Message extends IgnoreHostnameBrowserMessage
    ? { ignoredHostnames: string[] }
    : Message extends MigrateIgnoredHostnameBrowserMessage
    ? void
    : Message extends LogReplaceLinksBrowserMessage
    ? void
    : Message extends LogRedirectedLinkBrowserMessage
    ? void
    : never;
...
declare global {
  ...
  namespace browser.runtime {
    function sendMessage<Message extends BrowserMessage>(
      message: Message
    ): Promise<BrowserMessageResponse<Message>>;
  }
}
